...
Gli allofoni marchiati con * sono riprodotti in loop, all'infinito. Dove possibile, sono presenti alcuni esempi di parole inglesi e italiane contenenti gli allofoni descritti, le prime separate dalle seconde da un carattere di pipe |. Gli allofoni di LSDj sono comunque tarati prevalentemente su suoni propri della lingua inglese.

\subsection{Vocali brevi}

\begin{description}
\item[*IH] sitting, stranded | Pippo, giro
\item[*EH] extent, gentlemen | scendere
\item[*AE] extract, acting | pera
\item[*UH] cookie, full | uva, buco
\item[*AD] talking, song | pollo
\item[*AX] lapel, instruct | paté
\end{description}

\subsection{Vocali lunghe}

\begin{description}
\item[IY] treat, people, penny | mio, zio
\item[EY] great, statement, tray | plebei
\item[AY] kite, sky, mighty | mai, vai
\item[OI] noise, toy, voice | poi
\item[UW1] dopo gruppi consonantici con YY: computer
\item[UW2] nelle parole monosillabiche: two, food | tu, su
\item[OW] zone, close, snow
\item[AW] sound, mouse, down | fauno
